...
<div class="container shadow mb-5 bg-white rounded" style="background-color:white; padding:0px;">
    ...
    <div class="container">
        <table class="table table-hover">
            ...
            <tbody>
            <%
                ResultSet rs = db.get_List("select * from kullanicilar");
                while (rs.next()) { %>
            <tr>
                ...
                <td><%=rs.getString("vip_date") %>
                </td>
                <td><% int a = rs.getInt("vip");
                    if (a == 1)
                        System.out.print("Aktif");
                    else
                        System.out.print("Pasif");
                %></td>
                <td><% int b = rs.getInt("status");
                    if (b == 1)
                        System.out.print("Aktif");
                    else
                        System.out.print("Pasif");
                %></td>
                <td>
                    <a href="update.jsp?id="<%=rs.getString("id") %>>Düzenle</a> |
