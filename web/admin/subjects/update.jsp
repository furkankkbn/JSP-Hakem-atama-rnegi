    ...
    <div class="container">
        ...
        <%
            ...
            if (action_update != null && action_update.equals("true")) {
                ...
                query = "UPDATE qbdb.konular SET baslik='" + baslik + "',aciklama='" + aciklama + "',tarih='" + tarih + "' WHERE id=" + id;
                ...
                query = "delete from qbdb.konular WHERE id=" + id;
                boolean status = db.set_Command(query);
                response.sendRedirect("list.jsp");
            }

            baslik = db.get_Value("select baslik from konular where id=" + id, 1);
            aciklama = db.get_Value("select aciklama from konular where id=" + id, 1);
            tarih = db.get_Value("select tarih from konular where id=" + id, 1);
        %>
